...
urlpatterns = [
    ...
    path("reports/<int:report_id>/findings/create/", views.finding_create, name="finding_create"),
    path("reports/<int:report_id>/findings/from-kb/<int:entry_id>/", views.finding_from_kb, name="finding_from_kb"),
